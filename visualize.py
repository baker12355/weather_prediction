...
def heapmap(img):
    ...
    last_conv_layer = model1.get_layer("W24")
    ...
    cv2.putText(img, classes[class_idx], (10, 500), cv2.FONT_HERSHEY_TRIPLEX, 5, (0, 255, 255), 5, cv2.LINE_AA)
...
path = '/home/baker/Desktop/BDD100K/bdd100k/images/10k/val/'
files = os.listdir(path)

for file in files[100:300]:
    img_path = path + file

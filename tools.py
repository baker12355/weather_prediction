...
def image_to_matrix(image_root, dest, size):
    ...
    """
    mapping=['cloudy','foggy', 'rain', 'snow', 'sunny']
    
    #image_root = "../cropped100/"  # Change this root directory of images to create model for them
    batch_size_for_models = 183798  # 5000 sized batch models
    ...
    for cls in classes_dir:
        ...
        for imageName in class_list:
            ...
            if counter == batch_size_for_models:
                ...
                fc += 1
                counter = 0
        print (mapping[int(cls)],'has done.')
...
#image_to_matrix('//home//baker//Desktop//Image2Weather dataset//Image//','//home//baker//Desktop//Image2Weather dataset//image_digitalize//',50)
